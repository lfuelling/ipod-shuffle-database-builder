...
__version__="1.0-r666"
__author__="Lukas Fülling"
__email__="lukas@k40s.net"

""" VERSION HISTORY
1.0-r666 (2013-06-19)
	* forked by Lukas and slightly edited.
1.0-rc1 (2006-04-26)
...
Please make sure that:
 ...
 (*) you are actually using an iPod shuffle, and not some other iPod model :)""")
  ...
  try:
    ...
    log("		This looks like some kind of I/O-Error.")
    sys.exit(1)
